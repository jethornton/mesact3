...
inputs = [{'Not Used':'Select'},
	...
	{'Jog':[{'X Axis':['Jog X Plus', 'Jog X Minus', 'Jog X Enable', 'Jog X + Joint Enable']},
		{'Y Axis':['Jog Y Plus', 'Jog Y Minus', 'Jog Y Enable', 'Jog Y + Joint Enable']},
		{'Z Axis':['Jog Z Plus', 'Jog Z Minus', 'Jog Z Enable', 'Jog Z + Joint Enable']},
		{'A Axis':['Jog A Plus', 'Jog A Minus', 'Jog A Enable', 'Jog A + Joint Enable']},
		{'B Axis':['Jog B Plus', 'Jog B Minus', 'Jog B Enable', 'Jog B + Joint Enable']},
		{'C Axis':['Jog C Plus', 'Jog C Minus', 'Jog C Enable', 'Jog C + Joint Enable']},
		{'U Axis':['Jog U Plus', 'Jog U Minus', 'Jog U Enable', 'Jog U + Joint Enable']},
